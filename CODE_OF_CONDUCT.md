...
We are under the R-Ladies CoC. This is the English version but if you want to read it in Spanish or Portuguese you can go to the [translated version](https://github.com/rladies/starter-kit/wiki/Code-of-Conduct).
...
If you are being harassed by a member/guest/participant of/at R-Ladies, notice that someone else is being harassed, or have any other concerns, please contact the Founding Members via reporting [at] rladies [dot] org. Local incidences will be handled together with the local organisers. If the person who is harassing you is on the team, they will recuse themselves from handling your incident. We will respond as promptly as we can.
